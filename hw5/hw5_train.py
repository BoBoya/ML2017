...
def main():
    ...
    pickle.dump( tag_list, open( "label_mapping.p", "wb" ) )
    ...
    print("max_article_length= %d "%max_article_length)
    ###
    ...
    model.add(Embedding(num_words,
                        ...
                        trainable=False))
    model.add(GRU(256,activation='tanh',dropout=0.2,recurrent_dropout=0.2,use_bias=True, kernel_initializer='glorot_uniform'))
